  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes['#FF8F00'].geometry} position={[0.002, 0.042, 0]} scale={0.898}>
        <meshStandardMaterial color="#FF8F00" roughness={0.05} metalness={0.5} emissive="#FF8F00" emissiveIntensity={0.2} />
      </mesh>
      <mesh geometry={nodes['#FF6F00'].geometry} position={[0, 0.042, 0]} scale={0.898}>
        <meshStandardMaterial color="#FF6F00" roughness={0.05} metalness={0.5} emissive="#FF6F00" emissiveIntensity={0.2} />
      </mesh>
      <mesh geometry={nodes['#FFC400'].geometry} position={[0, 0.05, 0]} scale={0.898}>
        <meshStandardMaterial color="#FFC400" roughness={0.05} metalness={0.5} emissive="#FFC400" emissiveIntensity={0.2} />
      </mesh>
    </group>
  )
}
